...
declare module '$env/static/private' {
	export const __RTX_DIFF: string;
	export const TMUX: string;
	export const USER: string;
	export const npm_package_devDependencies__kitql_graphql_codegen: string;
	...
	export const npm_package_dependencies_svelte_forms_lib: string;
	...
	export const __RTX_WATCH: string;
	...
	export const npm_package_dependencies__graphql_codegen_typed_document_node: string;
	...
	export const npm_package_dependencies__kitql_client: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TMUX: string;
		USER: string;
		npm_package_devDependencies__kitql_graphql_codegen: string;
		...
		npm_package_dependencies_svelte_forms_lib: string;
		...
		PATH: string;
		NODE: string;
		npm_package_dependencies__graphql_codegen_typed_document_node: string;
		...
		npm_package_dependencies__kitql_client: string;
